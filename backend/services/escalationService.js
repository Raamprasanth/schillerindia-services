...
const SCHEDULER_GRACE_MS = Math.max(60000, parseInt(process.env.ESCALATION_SCHEDULER_GRACE_MS || '86400000', 10) || 86400000);
...
function buildUrEscalationRow(doc) {
  ...
  return {
    ...
    REP_BRD_DATE: pick(doc, ['repBrd', 'repBrdDate', 'obRepBrd', 'repairedBrdStkDate', 'repairedDate']),
    REPAIRED_BRD_STK_DATE: pick(doc, ['repBrd', 'repBrdDate', 'obRepBrd', 'repairedBrdStkDate', 'repairedDate']),
    'Repaired BRD Stk Date': pick(doc, ['repBrd', 'repBrdDate', 'obRepBrd', 'repairedBrdStkDate', 'repairedDate']),
    'Repaired BRD STK Date': pick(doc, ['repBrd', 'repBrdDate', 'obRepBrd', 'repairedBrdStkDate', 'repairedDate']),
    'REPAIRED BRD STK DATE': pick(doc, ['repBrd', 'repBrdDate', 'obRepBrd', 'repairedBrdStkDate', 'repairedDate']),
