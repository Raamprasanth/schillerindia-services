...
// ── Indexes ───────────────────────────────────────────────
CerSchema.index({ division: 1 });
CerSchema.index({ eng: 1, status: 1 });
CerSchema.index({ scEng: 1 });
CerSchema.index({ region: 1 });
CerSchema.index({ unitStatus: 1 });
CerSchema.index({ scRno: 1 });
CerSchema.index({ createdAt: 1 });
CerSchema.index({ frnId: 1 });
CerSchema.index({ serviceId: 1 });


module.exports = mongoose.model('Cer', CerSchema);
