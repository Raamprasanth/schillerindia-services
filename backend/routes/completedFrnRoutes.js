...
function toDTO(d) {
  return {
    ...
    frnNo:            d.frnNo            || '',
    region:           d.region           || '',
    eng:              d.eng              || d.engineer || d.engineerName || d.fieldEngineer || '',
    customer:         d.customer         || d.customerName || d.custName || '',
    model:            d.model            || '',
    unitStatus:       d.unitStatus       || '',
    partNo:           d.partNo           || d.partNumber || d.part_no || '',
    defMod:           d.defMod           || '',
    defGir:           d.defGir           || '',
    raEng:            d.raEng            || '',
...
router.post('/', protect, async (req, res) => {
  try {
    const {
      ...
      partNo, defMod, defGir, raEng, repBrdDate, dcNo,
