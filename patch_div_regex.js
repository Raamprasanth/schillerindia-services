...
const divRegex = /(<button class="btn btn-ghost" style="flex:1;justify-content:center;" onclick="loadLeaderboard\(\)">&#127942; Leaderboard<\/button>\s*<\/div>)/;
...
if (content.match(divRegex)) {
  content = content.replace(divRegex, newStr);
