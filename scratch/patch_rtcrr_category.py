...
# 3. Export Header
exp_head = "'Reverted Date', 'Entry Date', 'Closed Date', 'Division', 'SC Ref No'"
exp_head_new = "'Reverted Date', 'Entry Date', 'Closed Date', 'Division', 'Category', 'SC Ref No'"
...
with open('frontend/public/Rtcrr.html', 'w', encoding='utf-8') as f:
    f.write(content)
print("Patched Category into Rtcrr.html")
